...
public class Updater {
    ...
    public func install(path: String, completion: @escaping (_ error: String?) -> Void) {
        ...
        let mountedApp = (mountPoint as NSString).appendingPathComponent("StatsForKVM.app")
        ...
        let scriptDst = (NSTemporaryDirectory() as NSString).appendingPathComponent("statsforkvm-updater-\(UUID().uuidString).sh")
        do {
