...
extension AppDelegate {
    ...
    internal func defaultValues() {
        ...
        // Upstream Stats updates are intentionally not scheduled. StatsForKVM
        // needs a dedicated release feed before automatic updates are safe.
    }
    ...
    internal func checkForNewVersion(silent: Bool = false) {
        debug("StatsForKVM update check skipped: no dedicated release feed is configured")
    }
