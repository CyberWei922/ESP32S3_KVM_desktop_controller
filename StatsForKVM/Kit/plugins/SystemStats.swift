...
class MQTTManager: NSObject {
    ...
    private let stateQueue = DispatchQueue(label: "com.wei.statsforkvm.Remote.MQTT")
...
enum RemoteKeychain {
    private static let service: String = (Bundle.main.bundleIdentifier ?? "com.wei.statsforkvm") + ".remote"
