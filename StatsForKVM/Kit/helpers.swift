...
public class SMCHelper {
    ...
    private let id: String = "com.wei.statsforkvm.SMC.Helper"
    private let plistName: String = "com.wei.statsforkvm.SMC.Helper.plist"
    ...
    public func checkForUpdate() {
        ...
        let helperURL = Bundle.main.bundleURL.appendingPathComponent("Contents/Library/LaunchServices/com.wei.statsforkvm.SMC.Helper")
    ...
    private func installLegacy(completion: @escaping (_ state: SMCHelperInstallState) -> Void) {
        ...
        if SMJobBless(kSMDomainSystemLaunchd, "com.wei.statsforkvm.SMC.Helper" as CFString, authRef, &error) == false {
    ...
    private func helperConnection() -> NSXPCConnection? {
        ...
        let connection = NSXPCConnection(machServiceName: "com.wei.statsforkvm.SMC.Helper", options: .privileged)
