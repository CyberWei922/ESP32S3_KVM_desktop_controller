...
open class WidgetWrapper: NSView, widget_p {
    ...
    public init(_ type: widget_t, title: String, frame: NSRect) {
        ...
        self.queue = DispatchQueue(label: "com.wei.statsforkvm.WidgetWrapper.\(type.rawValue).\(title)")
...
public class MenuBar {
    ...
    init(moduleName: String) {
        ...
        self.queue = DispatchQueue(label: "com.wei.statsforkvm.MenuBar.\(moduleName)")
