...
class ApplicationSettings: NSStackView {
    ...
    private var systemWidgetsUpdatesState: Bool {
        get {
            let userDefaults = UserDefaults(suiteName: "\(Bundle.main.object(forInfoDictionaryKey: "TeamId") as! String).com.wei.statsforkvm.widgets")
    ...
    private func informationView() -> NSView {
        ...
        statsName.stringValue = "StatsForKVM"
        ...
        updateButton.title = localizedString("Updates are disabled")
