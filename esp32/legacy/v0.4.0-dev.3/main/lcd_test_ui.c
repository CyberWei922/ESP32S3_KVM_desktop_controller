...
static void draw_button_indicator(int x, bool pressed)
{
    lcd_fill_rect(x, 156, 16, 16, COLOR_DIM);
    lcd_fill_rect(x + 2, 158, 12, 12, pressed ? COLOR_GREEN : COLOR_GRAY);
}
...
void lcd_test_ui_show(void)
{
    ...
    draw_button_indicator(234, false);
    draw_button_indicator(260, false);
    draw_button_indicator(286, false);
...
{
    draw_button_indicator(234, (pressed_mask & BUTTON_MASK_LEFT) != 0);
    draw_button_indicator(260, (pressed_mask & BUTTON_MASK_MIDDLE) != 0);
    draw_button_indicator(286, (pressed_mask & BUTTON_MASK_RIGHT) != 0);
}
